...
data_loader = torch.utils.data.DataLoader(validate_data, batch_size=BATCH_SIZE, shuffle=True, collate_fn=my_collate)
...
model_state_dict = torch.load("output/model_epoch_30.model")
